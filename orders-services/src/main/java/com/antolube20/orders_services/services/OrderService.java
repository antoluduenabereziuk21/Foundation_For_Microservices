package com.antolube20.orders_services.services;

import com.antolube20.orders_services.model.dtos.*;
import com.antolube20.orders_services.model.entities.Order;
import com.antolube20.orders_services.model.entities.OrderItems;
import com.antolube20.orders_services.repositories.OrderRepository;
...
public class OrderService {
    ...
    public OrderResponse placeOrder(OrderRequest orderRequest) {
        ...
        BaseResponse result = this.webClientBuilder.build()
                .post()
                .uri("lb://inventory-services/api/inventory/in-stock")
